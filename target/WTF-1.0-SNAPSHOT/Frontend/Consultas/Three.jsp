...
<html>
    ...
    <body>
        ...
        <div class="container mt-1">
            <table> 
              <tr>  
                <th>Cantidad de clubes sugeridos para los tres estudiantes que más sugerencias hayan realizado</th>
              </tr>
              
              <tr>
                 <td style="color: black" vertical-align: "left"> <%= request.getAttribute("Q2") %>  </td> 
              </tr>
